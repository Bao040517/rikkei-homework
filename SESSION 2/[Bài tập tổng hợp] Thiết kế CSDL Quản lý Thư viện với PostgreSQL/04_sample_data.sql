...
\restrict R6RhfoocfMkWEdzaG8ffAsMq4xwxY3PniZsPqVw6UxnuQBdS6JCrNFOsKiIJR9L

-- Dumped from database version 18.0
-- Dumped by pg_dump version 18.0

-- Started on 2025-11-01 23:46:33
...
1	Nguyễn Nhật Ánh	Nhà văn nổi tiếng Việt Nam chuyên viết cho thiếu nhi
2	J.K. Rowling	Tác giả người Anh của bộ truyện Harry Potter
3	Stephen Hawking	Nhà vật lý học, nhà vũ trụ học và tác giả người Anh
\.
...
1	9786042113379	Tôi thấy hoa vàng trên cỏ xanh	2010	NXB Trẻ	10	8	1
2	9780747532743	Harry Potter and the Philosopher's Stone	1997	Bloomsbury	12	10	1
3	9780553380163	A Brief History of Time	1988	Bantam Books	5	4	2
\.
...
1	1	2025-10-20	2025-11-05	\N
2	2	2025-10-25	2025-11-10	2025-11-05
\.
...
1	Văn học	Các tác phẩm văn học cổ điển và hiện đại
2	Khoa học	Sách khoa học, kỹ thuật, công nghệ
...
1	Nguyễn Văn An	an.nguyen@example.com	0901234567	1999-05-12	Hà Nội	active	2025-11-01
2	Trần Thị Bình	binh.tran@example.com	0987654321	2000-08-22	TP. Hồ Chí Minh	active	2025-11-01
3	Lê Quốc Huy	huy.le@example.com	0911223344	1995-03-15	Đà Nẵng	inactive	2023-11-01
\.
...
SELECT pg_catalog.setval('library.borrow_details_borrow_detail_id_seq', 3, true);
...
SELECT pg_catalog.setval('library.borrow_slips_slip_id_seq', 2, true);
...
-- Completed on 2025-11-01 23:46:33

--
-- PostgreSQL database dump complete
--

\unrestrict R6RhfoocfMkWEdzaG8ffAsMq4xwxY3PniZsPqVw6UxnuQBdS6JCrNFOsKiIJR9L
